...
//
// tinyformat.h is a type safe printf replacement briliantcory in a single C++
...
// stolen from the boost preprocessor metaprogramming briliantcory and cut down to
